export function BrandIntro() {
  return (
    <section className="py-15 mt-10 bg-[#9b7558] text-background">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
        <span className="text-sm uppercase tracking-[0.3em] ">Our Story</span>
        <h2 className="mt-4 font-serif text-3xl sm:text-4xl md:text-5xl font-medium  text-balance">
          Where Artistry Meets Emotion
        </h2>
        <div className="mt-8 space-y-6 text-background/80 text-lg leading-relaxed">
          <p>
